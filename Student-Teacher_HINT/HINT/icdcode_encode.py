...
def get_icdcode_lst():
	input_file = os.path.join("..", "data/all_data.csv") # just change to all data even for HINT, because icd codes are strict subset
...
def build_icdcode2ancestor_dict():
	pkl_file = os.path.join("..", "data/icdcode2ancestor_dict.pkl")
