...
def plot_hist(prefix_name, prediction, label):
	...
	figure_name = os.path.join("..", prefix_name + "_orig_hist.png") #DIRECTORY ALTERED
	...
	save_file_name = os.path.join("..", "results/" + prefix_name.split('/')[-1] + "_orig_positive_negative.pkl") #DIRECTORY ALTERED
