...
def save_sentence_bert_dict_pkl():
	...
	pickle.dump(protocol_sentence_2_embedding, open(os.path.join("..", "data/sentence2embedding.pkl"), 'wb'))
	return 

def load_sentence_2_vec():
	sentence_2_vec = pickle.load(open(os.path.join("..", "data", "sentence2embedding.pkl"), 'rb'))
